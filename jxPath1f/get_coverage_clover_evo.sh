...
ant clean
rm -r  evosuite-tests/org/apache/commons/jxpath/**/**/**/*.class
rm -r  evosuite-tests/org/apache/commons/jxpath/**/**/*.class
rm -r  evosuite-tests/org/apache/commons/jxpath/**/*.class
rm -r  evosuite-tests/org/apache/commons/jxpath/*.class
defects4j compile
...
javac evosuite-tests/org/apache/commons/jxpath/**/**/**/*.java
javac evosuite-tests/org/apache/commons/jxpath/**/**/*.java
javac evosuite-tests/org/apache/commons/jxpath/**/*.java
javac evosuite-tests/org/apache/commons/jxpath/*.java

rm -rf target
export CLASSPATH=./target/lib:./target/classes:./evosuite-tests:./evosuite-standalone-runtime-1.0.6.jar:./junit-4.12.jar:hamcrest-core-1.3.jar
